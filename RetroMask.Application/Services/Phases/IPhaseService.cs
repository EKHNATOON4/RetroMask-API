...
public interface IPhaseService
{
    ...
    Task<ApiResponse<PhaseDto>> ExtendPhaseAsync(Guid phaseId, ExtendPhaseRequest request, CancellationToken ct = default);
    Task<ApiResponse<PhaseDto>> AdvanceToNextPhaseAsync(Guid sessionId, CancellationToken ct = default);
